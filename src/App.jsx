...
function App() {
  ...
  const blogInfo = [
    ...
    },
    {
      ...
      imageURL: "https://www.guvi.in/blog/wp-content/uploads/2023/01/paper-analysis-2-scaled.jpg",
    ...
    },
    {
      ...
      imageURL: "https://www.guvi.in/blog/wp-content/uploads/2022/06/Your-paragraph-text.png",
    ...
    },
    {
      ...
      imageURL: "https://www.guvi.in/blog/wp-content/uploads/2023/08/How-Long-Would-It-Take-to-Learn-Data-Science.png",
    ...
    },
    {
      ...
      imageURL: "https://www.guvi.in/blog/wp-content/uploads/2021/05/react-600x314.jpg",
    ...
    },
    {
      ...
      imageURL: "https://www.guvi.in/blog/wp-content/uploads/2023/03/1.jpg",
    ...
    },
    {
      ...
      imageURL: "https://www.guvi.in/blog/wp-content/uploads/2023/11/Best-_-High-Paying-IT-Jobs-For-Arts-Students.png",
  ...
  return (
    <>
      <BrowserRouter>
        <NavBar />
        <Routes>
          <Route path="/all" element={<All blogInfo={blogInfo} />}></Route>
